                    ...
                    <ul>
                        ...
                        <li class="am-dropdown tpl-dropdown" data-am-dropdown>
                            ...
                            <ul class="am-dropdown-content tpl-dropdown-content">
                                ...
                                <li class="tpl-dropdown-menu-messages">
                                    <a href="feedback" class="tpl-dropdown-menu-messages-item am-cf">
                        ...
                        <li class="am-dropdown" data-am-dropdown>
                            ...
                            <ul class="am-dropdown-content tpl-dropdown-content">
                                ...
                                <li class="tpl-dropdown-menu-notifications">
                                    <a href="form" class="tpl-dropdown-menu-notifications-item am-cf">
        ...
        <div class="left-sidebar">
            ...
            <ul class="sidebar-nav">
               ...
               <li class="sidebar-nav-link">
                ...
                <li class="sidebar-nav-link">
                    <a href="feedback.jsp" class="active">
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf">反馈</div>
...
<!--
                                <div class="am-u-sm-12 am-u-md-6 am-u-lg-6">
                                    <div class="am-form-group" style="opacity: 1;">
                                ...
                                <div class="am-u-sm-12 am-u-md-6 am-u-lg-3">
                                    <div class="am-form-group tpl-table-list-select">
                                        <select data-am-selected="{btnSize: 'sm'}">
							              ...
							              <option value="option3">时间</option>
							            </select>
                                    </div>
                                </div>
...
$(".edit").click(function() {
	...
	if(b == "2") {
		...
		//alert(b);
		console.log("2");
		$(this).parent().parent().parent().find("td:lt(4)").attr("contenteditable", true);
		$(this).parent().parent().parent().find("td:lt(4)").addClass('active');
