...
<%@page import="cn.zptc.entity.Owner"%>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-nav-link">
						...
						<ul class="sidebar-nav sidebar-nav-sub" style="display: block;">
							...
							<li class="sidebar-nav-link">
								<a href="/Face-AI/otransferServlet" class="sub-active">
						...
						<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
							<div class="widget am-cf">
								<div class="widget-head am-cf">
									<div class="widget-title  am-cf">业主</div>

								</div>
								<form action="/Face-AI/oqueryServlet">
									<div class="widget-body  am-fr">
										...
										<div class="am-u-sm-12">
											<table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black " id="myTable">
												...
												<tbody>
													<%try{
														Owner[] owners=(Owner[]) request.getSession().getAttribute("owners");
														...
														ArrayList addresslist=(ArrayList) request.getSession().getAttribute("addresslist");
...
$(".edit").click(function() {
	...
	if(b == "2") {
		//alert(b);
		$(this).parent().parent().parent().find("td:lt(4)").addClass('active');
		$(this).parent().parent().parent().find("td:nth-child(5) span").html('编辑');
		$(this).parent().parent().parent().find("td:lt(4)").attr("contenteditable", false);
		$(".edit").eq(index).attr("data-time", 1);
		var name = $(this).parent().parent().parent().find("td:nth-child(1)").html();
		var address = $(this).parent().parent().parent().find("td:nth-child(2)").html();
		var tell = $(this).parent().parent().parent().find("td:nth-child(3)").html();
		var id = $(this).parent().parent().parent().find("td:nth-child(4)").html();
		$.ajax({
			type: "post",
			url: "/Face-AI/oeditServlet",
			data: {
				"name": name,
				"address": address,
				"tell": tell,
		...
		$(this).parent().parent().parent().find("td:nth-child(5) span").html('保存');
