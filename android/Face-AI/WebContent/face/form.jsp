    ...
    <div class="am-g tpl-g">
        ...
        <div class="left-sidebar">
            ...
            <!-- 菜单 -->
               ...
               <li class="sidebar-nav-link">
                    <a href="/Face-AI/avtransferServlet" class="active">
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf">申请</div>


                            </div>
                            <form action="/Face-AI/avqueryServlet">
                                ...
                                <div class="am-u-sm-12 am-u-md-6 am-u-lg-3">
                                    <div class="am-form-group tpl-table-list-select">
                                        <select data-am-selected="{btnSize: 'sm'}" name="category">
							              ...
							              <option value="option3">业主身份证号</option>
							              <option value="option4">与业主的关系</option>
							              <option value="option5">联系方式</option>
							              <option value="option6">时间</option>
							            </select>
                                    </div>
                                </div>
                                    ...
                                    <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black " id="myTable">
                                        <thead>
                                            <tr>
                                            	<th width="10%">序列号</th>
                                                <th width="15%">姓名</th>
                                                <th width="15%">业主身份证号</th>
                                                <th width="15%">与业主的关系</th>
                                                <th width="15%">联系方式</th>
                                                <th width="15%">时间</th>
                                                <th>操作</th>
                                            </tr>
                                        ...
                                        <tbody>
                                        	<%try{
                                        		Visitor[] visitors=(Visitor[]) request.getSession().getAttribute("visitor");
                                        		...
                                        		ArrayList owneridlist=(ArrayList) request.getSession().getAttribute("ownerlist");
                                        		ArrayList relationlist=(ArrayList) request.getSession().getAttribute("relationlist");
                                        	...
                                        	<tr class="gradeX">
                                        		<td><%=idlist.get(j) %></td>
                                           		...
                                           		<td><%=owneridlist.get(j) %></td>
                                           		<td><%=relationlist.get(j) %></td>
                                           		<td><%=telllist.get(j) %></td>
                                           		<td><%=datalist.get(j) %></td>
                                                <td>
                                                    <div class="tpl-table-black-operation">
                                                        <a class="delete" href="javascript:;">
                                                            <i class="am-icon-pencil"></i> 同意
                                                        </a>
                                                        <a href="javascript:;" class="tpl-table-black-operation-del repulse">
                                                            <i class="am-icon-trash"></i> <span>拒绝</span>
                                                        </a>
                                                    </div>
                                                </td>
                                            </tr>
