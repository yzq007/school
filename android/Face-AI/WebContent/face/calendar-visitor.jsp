				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-nav-link">
						...
						<ul class="sidebar-nav sidebar-nav-sub" style="display: block;">							
							...
							<li class="sidebar-nav-link">
								<a href="calendar-visitor.jsp" class="sub-active">
						...
						<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
							<div class="widget am-cf">
								<div class="widget-head am-cf">
									<div class="widget-title am-fl">访客注册</div>
								...
								<div class="widget-body am-fr">
									...
									<form class="am-form tpl-form-line-form" action="/Face-AI/visitorServlet">
										<div class="am-form-group">
											<label for="user-name" class="am-u-sm-3 am-form-label">名字 <span class="tpl-form-line-small-title">Name</span></label>
											<div class="am-u-sm-9">
												<input type="text" class="tpl-form-input name" id="user-name" placeholder="请输入访客的名字" name="name">
												<!--<small>请填写标题文字10-20字左右。</small>-->
											</div>
										</div>
										
										<div class="am-form-group">
											<label for="user-name" class="am-u-sm-3 am-form-label">业主 <span class="tpl-form-line-small-title">OwnerId</span></label>
											<div class="am-u-sm-9">
												<input type="number" class="tpl-form-input sfzh" id="user-name" placeholder="请输入业主的身份证号" name="ownerid">
												<!--<small>请填写标题文字10-20字左右。</small>-->
											</div>
										</div>
										
										<div class="am-form-group">
											<label for="user-name" class="am-u-sm-3 am-form-label">与业主的关系 <span class="tpl-form-line-small-title">Relation</span></label>
											<div class="am-u-sm-9">
												<input type="text" class="tpl-form-input" id="user-name" placeholder="请输入与业主的关系" name="relation">
												<small>如：同事关系</small>
											</div>
										</div>
										...
										<div class="am-form-group">
											<label for="user-email" class="am-u-sm-3 am-form-label">访问时间 <span class="tpl-form-line-small-title">Time</span></label>
											<div class="am-u-sm-9">
												<input style="width: 20%; display: inline-block;text-align: center;" type="text" class="am-form-field tpl-form-no-bg" placeholder="开始" data-am-datepicker="" readonly="" name="start">~
												<input style="width: 20%; display: inline-block;text-align: center;" type="text" class="am-form-field tpl-form-no-bg" placeholder="结束" data-am-datepicker="" readonly="" name="stop">
											</div>
										</div>						
