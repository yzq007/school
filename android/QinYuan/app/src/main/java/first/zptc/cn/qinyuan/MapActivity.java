...
import first.zptc.cn.qinyuan.util.AMapUtil;
import first.zptc.cn.qinyuan.util.Utils;

public class MapActivity extends AppCompatActivity implements AMapLocationListener,GeocodeSearch.OnGeocodeSearchListener{
            ...
            switch (msg.what) {
                ...
                case Utils.MSG_LOCATION_FINISH:
                    ...
                    try {
                        ...
                        strMsg = result.split(",");
                        Toast.makeText(MapActivity.this, "定位成功", Toast.LENGTH_LONG).show();
    ...
    public void Location() {
        ...
        try {
            ...
            Log.d("tag", "Location:4 ");
            locationOption.setOnceLocation(true);//设置为单次定位
            Log.d("tag", "Location:5 ");
            locationClient.setLocationOption(locationOption);// 设置定位参数
            Log.d("tag", "Location:6 ");
            // 启动定位
            locationClient.startLocation();
            Log.d("tag", "Location:7 ");
    ...
    public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
        if (rCode == 1000) {
            if (result != null && result.getRegeocodeAddress() != null
                ...
                Toast.makeText(MapActivity.this,result.getRegeocodeAddress().getFormatAddress()
